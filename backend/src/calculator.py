...
if __name__ == "__main__":
    ...
    simulate(do_print=True, grant=True, daily_usage=3, load_to_sell=False, provider="tauron", switching_from_static=False, solar_avaialable=False, tariff="G13", staying_static=False, starting_tariff="G13")
